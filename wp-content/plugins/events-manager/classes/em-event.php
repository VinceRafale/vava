...
remove_filter('dbem_notes', 'do_shortcode');
// filters for the notes field in html (corresponding to those of  "the _content")
remove_filter('dbem_notes_excerpt', 'wptexturize');
remove_filter('dbem_notes_excerpt', 'convert_smilies');
remove_filter('dbem_notes_excerpt', 'convert_chars');
remove_filter('dbem_notes_excerpt', 'wpautop');
remove_filter('dbem_notes_excerpt', 'prepend_attachment');
remove_filter('dbem_notes_excerpt', 'do_shortcode');
// RSS content filter
