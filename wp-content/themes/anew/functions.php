...
if ( function_exists('register_sidebar') ) {
        register_sidebar();
        register_sidebar(array('name'=>'slider'));
}
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name'=> 'bottom-widget1',
		'id' => 'bottom-widget1',
		'before_widget' => '<div id="%1$s" class="widget-bottom1 widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="bottom-widget1-h2"><h2 class="offscreen">',
		'after_title' => '</h2></div>',
	));
}
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name'=> 'bottom-widget2',
		'id' => 'bottom-widget2',
		'before_widget' => '<div id="%1$s" class="widget-bottom2 widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="bottom-widget2-h2"><h2 class="offscreen">',
		'after_title' => '</h2></div>',
	));
}
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name'=> 'bottom-widget3',
		'id' => 'bottom-widget3',
		'before_widget' => '<div id="%1$s" class="widget-bottom3 widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="bottom-widget3-h2"><h2 class="offscreen">',
		'after_title' => '</h2></div>',
	));
}