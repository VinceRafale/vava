...
<footer id="page-footer">
    <div class="wrapper">
        <div class="row-fluid">
            <div class="span12">
                <p id="copyright"><?php 
                if ( get_option( 'kopa_theme_options_copyright' ) ) {
                    echo wp_autop( get_option( 'kopa_theme_options_copyright' ) );
                } else {
                    printf( __( 'Copyright &copy; %1$s Kopasoft.', kopa_get_domain() ), date('Y') );
                }
                ?></p>
            </div><!--span12-->
        </div><!--row-fluid-->
