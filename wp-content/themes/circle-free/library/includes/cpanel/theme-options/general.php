<div class="kopa-content-box tab-content tab-content-1" id="tab-general">
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <textarea class="" rows="6" id="kopa_setting_copyrights" name="kopa_theme_options_copyright"><?php echo htmlspecialchars_decode(stripslashes(get_option('kopa_theme_options_copyright', sprintf( __( 'Copyright &copy; %1$s Kopasoft.', kopa_get_domain() ), date('Y') )))); ?></textarea>
        </div><!--kopa-element-box-->
