...
function kopa_admin_menu() {
    ...
    $page_kopa_cpanel_sidebar_management = add_theme_page(
            __('Sidebar Manage', kopa_get_domain()), __('Sidebar Manager', kopa_get_domain()), 'edit_themes', 'kopa_cpanel_sidebar_management', 'kopa_cpanel_sidebar_management'
    );
    ...
    $page_kopa_cpanel_layout_management = add_theme_page(
            __('Layout Manage', kopa_get_domain()), __('Layout Manager', kopa_get_domain()), 'edit_themes', 'kopa_cpanel_layout_management', 'kopa_cpanel_layout_management'
    );
