...
<?php // Post featured image
	if(has_post_thumbnail())  {
		...
		if (!is_single()){ ?></a><?php }
			...
			<p class='post-meta' style="margin-left:<?php if(has_post_thumbnail()) echo ($SMTheme->get( 'layout', 'imgwidth' )+20); ?>px">				
				In category&nbsp;<?php the_category(', '); 
				
				if(comments_open( get_the_ID() ))  {
                    ?>
					<span class='post-date'><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/date.png"></span><?php echo get_the_date(); ?></span>
					<img alt="" src="<?php echo get_template_directory_uri(); ?>/images/smt/comments.png" class="meta-com-img">Comments:&nbsp;<span class="meta_comments"><?php comments_popup_link( $SMTheme->_( 'noresponses' ), $SMTheme->_( 'oneresponse' ), $SMTheme->_( 'multiresponse' ) ); ?></span>
				<?php } 
