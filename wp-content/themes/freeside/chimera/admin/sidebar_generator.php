...
class sidebar_generator_chimera {
	
	function sidebar_generator_chimera() {
		add_action('init',array('sidebar_generator_chimera','init'));		
	}
	...
	function init(){
	    ...
	    if(is_array($sidebars)){
			...
			foreach($sidebars as $sidebar){
				$sidebar_class = sidebar_generator_chimera::name_to_class($sidebar);
				register_sidebar(array(
			    	'name'=>$sidebar,
					'id'=> "chimera_sidebar-$z",
...
?>
							...
							<?php if ( !function_exists('register_sidebar') || !dynamic_sidebar("default_sidebar") ) : ?>
							<?php endif; ?>
...
$sbg = new sidebar_generator_chimera;

function generated_dynamic_sidebar_chimera($index){
	sidebar_generator_chimera::get_sidebar($index);	
	return true;
}
?>
