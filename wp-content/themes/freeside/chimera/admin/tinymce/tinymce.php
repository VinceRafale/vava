...
class add_chimera_button {
	
	var $pluginname = 'chimera_shortcode';
	var $path = '';
	var $internalVersion = 100;
	
	function add_chimera_button()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/chimera/admin/tinymce/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = TEMPLATEPATH . '/chimera/admin/tinymce/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_chimera_button ();
