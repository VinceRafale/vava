...
$page_postmetas = 
	array (
		...
		*/
		array("section" => "Page Slider", "id" => "page_slider", "type" => "select", "title" => "Select Page slider", "items" => array("none", "Slideshow", "Content Slider", "nivoSlider", "Accordion", "Image Rotator", "FeaturedList")),
		
		array("section" => "Tagline button text", "id" => "page_tagline_button_text", "type" => "text", "title" => "Enter button text to display in this page tagline header", "std" => ""),
		
		array("section" => "Tagline button link", "id" => "page_tagline_button_link", "type" => "text", "title" => "Enter button link", "std" => ""),
